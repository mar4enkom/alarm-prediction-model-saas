def getForecast():
    ...
    cities = ["Kyiv", "Odesa", "Kharkiv","L'viv","Chernihiv","Ternopil","Poltava","Donetsk","Dnipro","Chernivtsi","Cherkasy","Khmelnytskyi","Kherson","Rivne","Mykolaiv","Luhansk","Kropyvnytskyi","Ivano-Frankivsk","Zaporozhye","Uzhgorod","Zhytomyr","Lutsk","Vinnytsia","Simferopol","Soumy"]

    # Відкриваємо CSV-файл для запису даних
    with open('weather_all_cities.csv', mode='a', newline='') as file:
        writer = csv.writer(file)

        # Записуємо заголовки стовпців, якщо файл ще не існує
        if file.tell() == 0:
        ...
        # Записуємо дані для кожного міста
        for city in cities:
            url = f"https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/{city}/next12hours?key=Q9FH7HGQAXYQM4GGQFBHMEC3S&include=hours"
            with urllib.request.urlopen(url) as response:
                ...
                for hour in forecast_data:
                    writer.writerow([
                        ...
                        hour['windspeed'], # Записуємо швидкість віт
    ...
    # %%
    # Завантажуємо файли
    weather_df = pd.read_csv('weather_all_cities.csv', sep=",")
    ...
    result = list(zip(new_data['city'], new_data['hour_datetime'], y_pred))
